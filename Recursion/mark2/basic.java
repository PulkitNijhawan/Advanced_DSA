...
public class basic{
    ...
    public static int permuteDupliVT(String ques,String ans){
        ...
        int cnt=0;
        for(int i=0;i<ques.length();i++){
            if(repeat[ques.charAt(i)-'a']!=1)cnt+=permuteDupliVT(ques.substring(0, i)+ques.substring(i+1), ans+ques.charAt(i));
